...
public final class MyServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "net.devh.boot.grpc.example.MyService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<examples.lib.HelloRequest,
      examples.lib.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = examples.lib.HelloRequest.class,
      responseType = examples.lib.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<examples.lib.HelloRequest,
      examples.lib.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<examples.lib.HelloRequest, examples.lib.HelloReply> getSayHelloMethod;
      ...
      synchronized (MyServiceGrpc.class) {
        if ((getSayHelloMethod = MyServiceGrpc.getSayHelloMethod) == null) {
          MyServiceGrpc.getSayHelloMethod = getSayHelloMethod =
              io.grpc.MethodDescriptor.<examples.lib.HelloRequest, examples.lib.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  examples.lib.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  examples.lib.HelloReply.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void sayHello(examples.lib.HelloRequest request,
        io.grpc.stub.StreamObserver<examples.lib.HelloReply> responseObserver) {
  ...
  public static final class MyServiceStub
     ...
     * </pre>
     */
    public void sayHello(examples.lib.HelloRequest request,
        io.grpc.stub.StreamObserver<examples.lib.HelloReply> responseObserver) {
  ...
  public static final class MyServiceBlockingStub
     ...
     * </pre>
     */
    public examples.lib.HelloReply sayHello(examples.lib.HelloRequest request) {
  ...
  public static final class MyServiceFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<examples.lib.HelloReply> sayHello(
        examples.lib.HelloRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((examples.lib.HelloRequest) request,
              (io.grpc.stub.StreamObserver<examples.lib.HelloReply>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              examples.lib.HelloRequest,
              examples.lib.HelloReply>(
  ...
  private static abstract class MyServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return examples.lib.HelloWorldProto.getDescriptor();
    }
